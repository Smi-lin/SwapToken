  ...
  constructor(
    ...
    function swapTokenCeloToTokenBase(uint256 amountA) public {
      require(msg.sender != address(0), "Zero address not allowed");
        ...
        require(celo.balanceOf(msg.sender) >= amountA, "Not enough Token B in contract");

       
        require(celo.transferFrom(msg.sender, address(this), amountA), "Token A transfer failed");
    ...
    function swapTokenBaseToTokenCelo(uint256 amountB) public {
        ...
        require(base.balanceOf(address(this)) >= amountB, "Not enough Token A in contract");

        
        require(base.transferFrom(msg.sender, address(this), amountB), "Token B transfer failed");
